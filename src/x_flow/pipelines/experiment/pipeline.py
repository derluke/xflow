    ...
    nodes = [
        node(
            ...
            inputs={
                ...
                "name": "params:project.use_case_name",
            },
            outputs="use_case_id",
        ...
        node(
            ...
            inputs={
                "df": "raw_data_train",
                "target_column": "params:project.analyze_and_model.target",
                "partition_column": "params:project.partition_column",
                "date_column": "params:project.datetime_partitioning.datetime_partition_column",
                "date_format": "params:project.date_format",
            },
            outputs="data_train",
        ),
        node(
            ...
            inputs={
                "binarize_data_config": "params:project.binarize_data_config",
            },
        ...
        node(
            ...
            inputs={
                "fire_config": "params:project.fire_config",
            },
        ...
        node(
            ...
            inputs={
                "use_case_name": "params:project.use_case_name",
                "binarize_data_config": "params:project.binarize_data_config",
            },
